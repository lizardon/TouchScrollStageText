...
//		spark.skins.mobile.supportClasses.StageTextSkinBase
//
////////////////////////////////////////////////////////////////////////////////
//
...
package com.lizardon.touchscrollstagetext
{
	 ...
	 */
	public class TouchScrollStageTextSkinBase extends MobileSkin
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 * 
		 */
		public function TouchScrollStageTextSkinBase()
		{
			super();
		 ...
		 *  @productversion Flex 4.6
		 */
		public var textDisplay:TouchScrollStyleableStageText;
		...
		override protected function createChildren():void
		{
			...
			if (!textDisplay)
			{
				textDisplay = new TouchScrollStyleableStageText(multiline);
